  ...
  public static void main(String[] args) throws IOException {
    ...
    Integer a = Integer.parseInt(st.nextToken());
	  Integer b = Integer.parseInt(st.nextToken());
	   ...
	   Integer resultPimentoesX = CalcularPimentoes(a,b);
	   System.out.println( "X = " + resultPimentoesX);
  }
  
  private static Integer CalcularPimentoes(Integer vermelho, Integer amarelo){
   return vermelho + amarelo;
  }
}
